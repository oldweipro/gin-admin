	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(app.Config.AutoCode.Root, app.Config.AutoCode.Server, "api", "v1", "enter.go"),
				ImportPath:        `"github.com/oldweipro/gin-admin/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(app.Config.AutoCode.Root, app.Config.AutoCode.Server, "router", "enter.go"),
				ImportPath:        `"github.com/oldweipro/gin-admin/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(app.Config.AutoCode.Root, app.Config.AutoCode.Server, "service", "enter.go"),
				ImportPath:        `"github.com/oldweipro/gin-admin/service/example"`,
