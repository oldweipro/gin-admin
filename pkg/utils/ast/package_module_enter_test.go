	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(app.Config.AutoCode.Root, app.Config.AutoCode.Server, "router", "example", "enter.go"),
				ImportPath:  `api "github.com/oldweipro/gin-admin/api/v1"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(app.Config.AutoCode.Root, app.Config.AutoCode.Server, "api", "v1", "example", "enter.go"),
				ImportPath:  `"github.com/oldweipro/gin-admin/service"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(app.Config.AutoCode.Root, app.Config.AutoCode.Server, "service", "example", "enter.go"),
				ImportPath:  ``,
