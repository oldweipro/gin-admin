...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "1", V1: "/api/syncApi", V2: "GET"},
		{Ptype: "p", V0: "1", V1: "/api/getApiGroups", V2: "GET"},
		{Ptype: "p", V0: "1", V1: "/api/enterSyncApi", V2: "POST"},
		{Ptype: "p", V0: "1", V1: "/api/ignoreApi", V2: "POST"},
		...
		{Ptype: "p", V0: "1", V1: "/user/setSelfSetting", V2: "PUT"},
		...
		{Ptype: "p", V0: "1", V1: "/fileUploadAndDownload/importURL", V2: "POST"},
		...
		{Ptype: "p", V0: "1", V1: "/system/reloadSystem", V2: "POST"},
		...
		{Ptype: "p", V0: "1", V1: "/autoCode/getTemplates", V2: "GET"},
		...
		{Ptype: "p", V0: "1", V1: "/autoCode/addFunc", V2: "POST"},
		...
		{Ptype: "p", V0: "1", V1: "/email/sendEmail", V2: "POST"},
		...
		{Ptype: "p", V0: "1", V1: "/info/createInfo", V2: "POST"},
		{Ptype: "p", V0: "1", V1: "/info/deleteInfo", V2: "DELETE"},
		{Ptype: "p", V0: "1", V1: "/info/deleteInfoByIds", V2: "DELETE"},
		{Ptype: "p", V0: "1", V1: "/info/updateInfo", V2: "PUT"},
		{Ptype: "p", V0: "1", V1: "/info/findInfo", V2: "GET"},
		{Ptype: "p", V0: "1", V1: "/info/getInfoList", V2: "GET"},

		{Ptype: "p", V0: "2", V1: "/user/admin_register", V2: "POST"},
		{Ptype: "p", V0: "2", V1: "/api/getApiGroups", V2: "GET"},
		...
		{Ptype: "p", V0: "2", V1: "/fileUploadAndDownload/importURL", V2: "POST"},
		...
		{Ptype: "p", V0: "3", V1: "/api/getApiGroups", V2: "GET"},
		...
		{Ptype: "p", V0: "3", V1: "/fileUploadAndDownload/editFileName", V2: "POST"},
		{Ptype: "p", V0: "3", V1: "/fileUploadAndDownload/importURL", V2: "POST"},
