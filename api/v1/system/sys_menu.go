...
func (a *AuthorityMenuApi) GetMenu(c *gin.Context) {
	menus, err := menuService.GetMenuTree(utils2.GetUserAuthorityId(c))
	if err != nil {
...
func (a *AuthorityMenuApi) GetBaseMenuTree(c *gin.Context) {
	authority := utils2.GetUserAuthorityId(c)
...
func (a *AuthorityMenuApi) AddMenuAuthority(c *gin.Context) {
	...
	if err := utils2.Verify(authorityMenu, utils2.AuthorityIdVerify); err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	...
	if err := menuService.AddMenuAuthority(authorityMenu.Menus, adminAuthorityID, authorityMenu.AuthorityId); err != nil {
		app.Logger.Error("添加失败!", zap.Error(err))
...
func (a *AuthorityMenuApi) GetMenuAuthority(c *gin.Context) {
	...
	err = utils2.Verify(param, utils2.AuthorityIdVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (a *AuthorityMenuApi) AddBaseMenu(c *gin.Context) {
	...
	err = utils2.Verify(menu, utils2.MenuVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	err = utils2.Verify(menu.Meta, utils2.MenuMetaVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (a *AuthorityMenuApi) DeleteBaseMenu(c *gin.Context) {
	...
	err = utils2.Verify(menu, utils2.IdVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (a *AuthorityMenuApi) GetBaseMenuById(c *gin.Context) {
	...
	err = utils2.Verify(idInfo, utils2.IdVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
