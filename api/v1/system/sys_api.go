...
func (s *SystemApiApi) CreateApi(c *gin.Context) {
	...
	err = utils2.Verify(api, utils2.ApiVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (s *SystemApiApi) SyncApi(c *gin.Context) {
	...
	if err != nil {
		app.Logger.Error("同步失败!", zap.Error(err))
...
func (s *SystemApiApi) IgnoreApi(c *gin.Context) {
	...
	if err != nil {
		app.Logger.Error("忽略失败!", zap.Error(err))
...
func (s *SystemApiApi) DeleteApi(c *gin.Context) {
	...
	err = utils2.Verify(api.BaseModel, utils2.IdVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (s *SystemApiApi) GetApiList(c *gin.Context) {
	...
	err = utils2.Verify(pageInfo.PageInfo, utils2.PageInfoVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (s *SystemApiApi) FreshCasbin(c *gin.Context) {
	...
	if err != nil {
		app.Logger.Error("刷新失败!", zap.Error(err))
