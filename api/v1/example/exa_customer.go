...
func (e *CustomerApi) CreateExaCustomer(c *gin.Context) {
	...
	err = utils2.Verify(customer, utils2.CustomerVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	customer.SysUserID = utils2.GetUserID(c)
	customer.SysUserAuthorityID = utils2.GetUserAuthorityId(c)
...
func (e *CustomerApi) DeleteExaCustomer(c *gin.Context) {
	...
	err = utils2.Verify(customer.BaseModel, utils2.IdVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (e *CustomerApi) GetExaCustomerList(c *gin.Context) {
	...
	customerList, total, err := customerService.GetCustomerInfoList(utils2.GetUserAuthorityId(c), pageInfo)
	if err != nil {
		app.Logger.Error("获取失败!", zap.Error(err))
