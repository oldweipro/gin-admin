...
type TransactionHistory struct {
	...
	BeforeBalance *int   `json:"beforeBalance" form:"beforeBalance" gorm:"default:0;column:before_balance;comment:交易前钱包金额。;"`
	AfterBalance  *int   `json:"afterBalance" form:"afterBalance" gorm:"default:0;column:after_balance;comment:交易后钱包金额。;"`
