...
type RedeemCode struct {
	...
	TotalCount    uint      `json:"totalCount" form:"totalCount" gorm:"column:total_count;comment:总数量,该批兑换码的总数量;"`
	LeftCount     uint      `json:"leftCount" form:"leftCount" gorm:"column:left_count;comment:剩余数量,该批兑换码的剩余可用数量;"`
	...
	TotalRedeemed uint      `json:"totalRedeemed" form:"totalRedeemed" gorm:"column:total_redeemed;comment:总兑换次数,该批码已被兑换的总次数;"`
}
