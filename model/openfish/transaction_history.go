...
type TransactionHistory struct {
	...
	WalletId  *int   `json:"walletId" form:"walletId" gorm:"column:wallet_id;comment:与钱包表中的WalletID字段相关联，表示交易涉及的钱包。;"`
	...
	Quantity  *int   `json:"quantity" form:"quantity" gorm:"column:quantity;comment:表示交易中购买的商品数量。;"`
	Amount    *int   `json:"amount" form:"amount" gorm:"column:amount;comment:交易涉及的金额。;"`
