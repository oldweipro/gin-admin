...
func (j *JWT) CreateClaims(baseClaims request.BaseClaims) request.CustomClaims {
	bf, _ := ParseDuration(global.ConfigServer.JWT.BufferTime)
	ep, _ := ParseDuration(global.ConfigServer.JWT.ExpiresTime)
	claims := request.CustomClaims{
		...
		RegisteredClaims: jwt.RegisteredClaims{
			...
			Issuer:    global.ConfigServer.JWT.Issuer,            // 签名的发行者
		},
	}
	return claims
}
